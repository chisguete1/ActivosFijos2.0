...
public class Aulas extends javax.swing.JPanel {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        int filaSeleccionada = tbAulas.getSelectedRow();
        if (filaSeleccionada != -1) {
            int idAula = (int) modeloTabla.getValueAt(filaSeleccionada, 0);
            if (aulaControlador.eliminarAula(idAula)) {
                JOptionPane.showMessageDialog(this, "Aula eliminada con éxito");
                cargarAulas();
                limpiarCampos();
                aulaSeleccionada = -1;
            } else {
                JOptionPane.showMessageDialog(this, "Error al eliminar la aula", "Error", JOptionPane.ERROR_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(this, "Debe seleccionar una aula para eliminar", "Error", JOptionPane.ERROR_MESSAGE);
        }
