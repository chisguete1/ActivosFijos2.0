...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Creado por Limberth Claros Felix");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 360, 500, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/login.gif"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 40, 320, 340));
        ...
        jLabel4.setText("Sistema de Activos Fijos");
        ...
        jPanel2.add(txtcorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(39, 140, 240, 30));
        ...
        jPanel2.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 310, 341, 40));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Usuario usuario = usuarioControlador.autenticarUsuario(email, password);

        if (usuario != null) {
            // Si la autenticación es correcta, abrir la ventana principal
